...
namespace Pacman
{
    public abstract class SpriteBase
    {
        ...
        public SpriteBase(Texture2D Image, Vector2 Position, Color Tint)
        {
            this.Image = Image;
        ...
        public SpriteBase(Texture2D Image, Vector2 Position, Color Tint, Vector2 Scale, Vector2 Origin, float Rotation, SpriteEffects spriteEffects)
        {
            this.Image = Image;
            this.Position = Position;
            this.Tint = Tint;
